...
const reviews = [
  {
    ...
    rating: 5,
    time: "Há 4 dias",
    text: "Excelente atendimento e atenção redobrada ao cliente, nota mil!",
  },
  {
    name: "Jonathas Ferraz",
    initials: "JF",
    color: "#EA4335",
    rating: 5,
    time: "Há 4 dias",
    text: "Recomendo muito a Carvalho Engenharia! Precisava de ajuda com a regularização de imóveis e eles cuidaram de tudo com uma eficiência incrível. Além do conhecimento técnico, eles atuam como um verdadeiro despachante imobiliário, resolvendo toda a parte burocrática que parece impossível para nós. O Caio é extremamente profissional e transparente em todas as etapas do processo. Nota 10",
  },
  {
    name: "Advandes Cardoso",
    initials: "AC",
    color: "#34A853",
    rating: 5,
    time: "Há 4 dias",
    text: "Fui muito bem atendido, foi resolvido todos os meus problemas. Parabéns, muito obrigada",
  },
  {
    name: "Edson Ribeiro",
    initials: "ER",
    ...
    rating: 5,
    time: "Há 4 dias",
    text: "Serviço nota 10! Precisávamos resolver a regularização do imóvel e a burocracia parecia infinita. O suporte da Carvalho Engenharia foi impecável, resolvendo os trâmites com a rapidez de um despachante imobiliário, mas com toda a segurança e precisão técnica de um engenheiro. Recomendo!",
  },
  {
    name: "Fabiano Fontenelle",
    initials: "FF",
    color: "#9C27B0",
    rating: 5,
    time: "Há 4 dias",
    text: "O melhor atendimento que já tive! Estávamos perdidos com a papelada e precisávamos de uma regularização do imóvel urgente. O Caio da Carvalho Engenharia deu um show de agilidade, resolvendo todas as pendências nos órgãos públicos com a eficiência de um despachante imobiliário, mas com toda a segurança técnica de um engenheiro. Serviço impecável e de total confiança!",
  },
  {
    name: "Rafael Barbosa",
    initials: "RB",
    ...
    rating: 5,
    time: "Há 4 dias",
    text: "Salvou nosso tempo e nossa paciência! Precisávamos de ajuda com a regularização do imóvel e toda a burocracia com a documentação parecia interminável. A Carvalho Engenharia nos deu um suporte completo, prestando um serviço ágil e eficiente, quase como um despachante imobiliário especializado em destravar trâmites. Profissionalismo impecável do início ao fim. Recomendo demais",
  },
  {
    name: "Artur Rockefeller",
    initials: "AR",
    color: "#FF5722",
    rating: 5,
    time: "Há 4 dias",
    text: "Contratamos a Carvalho Engenharia para uma consultoria de engenharia e todo o suporte com o habite-se e a regularização da nossa reforma. O atendimento do Caio foi impecável, muito transparente e ágil com os trâmites da prefeitura. É um profissional extremamente qualificado e de total confiança. Indico de olhos fechados!",
  },
  {
    name: "Jorge Furlan",
    initials: "JF",
    ...
    rating: 5,
    time: "Há 4 dias",
    text: "Profissional excepcional e de total confiança! Precisávamos de um laudo técnico detalhado e de um suporte especializado em engenharia civil para o nosso empreendimento. A Carvalho Engenharia entregou um trabalho impecável, com muita clareza nos prazos e excelência na execução de obra. É raro encontrar um parceiro tão dedicado e técnico. Indico de verdade!",
  },
  {
    name: "Roberto Heinsehauer",
    initials: "RH",
    color: "#FF7043",
    rating: 5,
    time: "Há 4 dias",
    text: "Excelente profissional! Contratei o serviço de aprovação de projeto e regularização de imóvel com a Carvalho Engenharia e o atendimento foi impecável do início ao fim. O Caio é um engenheiro civil extremamente competente, ágil e resolveu toda a burocracia com a prefeitura sem nenhuma dor de cabeça. Super recomendo o trabalho!",
  },
  {
    ...
    rating: 5,
    time: "Há 1 semana",
    text: "Muito atencioso e prestativo. Serviço de qualidade.",
  },
  {
    name: "Maria Santana",
    initials: "MS",
    ...
    rating: 5,
    time: "Há 2 semanas",
    text: "Excelente profissional! Recomendo a todos! Parabéns à Carvalho Engenharia.",
  },
  {
    name: "Celia Dias",
    initials: "CD",
    ...
    rating: 5,
    time: "Há 2 semanas",
    text: "Profissional excelente, executou a planta e a regularização do imóvel dos meus pais em tempo hábil, recomendo!!",
  },
  {
    name: "Julia Magalhães",
    initials: "JM",
    color: "#795548",
    rating: 5,
    time: "Há 2 semanas",
    text: "Ótimo serviço, nos ajudou a resolver muitos impasses, esclareceu dúvidas e sempre buscando nos ajudar da melhor forma! Recomendo!",
  },
  {
    name: "Joao Felipe",
    initials: "JF",
    ...
    rating: 5,
    time: "Há 2 semanas",
    text: "Atendimento excelente, de confiança indico sempre",
  },
  {
    name: "Mc Pinheiro",
    initials: "MP",
    ...
    rating: 5,
    time: "Há 3 semanas",
    text: "Muito satisfeito com a empresa! Gratidão",
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    time: "Há 2 semanas",
    text: "Excelente trabalho! Profissional extremamente competente, responsável e cuidadoso em cada detalhe. Fiquei muito satisfeita com o resultado e com a qualidade do serviço. Recomendo de olhos fechados!",
  },
  {
    name: "Juracy Soares",
    initials: "JS",
