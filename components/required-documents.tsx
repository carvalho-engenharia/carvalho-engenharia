...
const documentSets = [
  ...
  },
  {
    key: "inss",
    icon: Landmark,
    title: "INSS de Obra (CNO, SERO e CND)",
    subtitle: "Regularização fiscal da obra junto à Receita Federal",
    lei: "Instrução Normativa RFB nº 2.061/2021 (Cadastro Nacional de Obras) e Manual do SERO da Receita Federal",
    documents: [
      "Inscrição da obra no CNO em até 30 dias do início, pelo portal e-CAC",
      "ART/RRT do responsável técnico pela obra",
      "Alvará de Construção e Habite-se",
      "Plantas assinadas do projeto aprovado",
      "Relação de trabalhadores, notas fiscais e comprovantes de recolhimento do INSS (empregados, autônomos e prestadores)",
      "Aferição da obra no SERO, com cálculo do INSS conforme área e padrão construtivo",
      "Emissão da CND de obra após a quitação de eventuais débitos",
    ],
  },
  {
    key: "averbacao",
    ...
    subtitle: "Atualização da construção na matrícula do imóvel",
    lei: "Exigências do Cartório de Registro de Imóveis de Goiânia (1ª Circunscrição) e da Prefeitura de Goiânia",
    documents: [
      "Requerimento de averbação assinado pelo proprietário, com firma reconhecida (ou assinatura digital ICP-Brasil/gov.br)",
      "Procuração com firma reconhecida, se representado por procurador",
      "Certidão de Registro do Imóvel de Inteiro Teor atualizada (validade 30 dias)",
      "Certidão de Cadastramento para fins de averbação, emitida pela Prefeitura de Goiânia",
      "Declaração cadastral do imóvel e BIC (Boletim de Informações Cadastrais)",
      "Termo de Habite-se e quadro de área registrado em cartório",
      "Projeto arquitetônico aprovado conforme o habite-se",
      "Numeração oficial predial da edificação, emitida pela Prefeitura (quando houver)",
      "CND de INSS da obra, quando exigida pelo cartório",
    ],
  },
]
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-[#066bef]/25 bg-white p-8 text-center">
          ...
          <a
            href="https://api.whatsapp.com/send?phone=5562998062169&text=Ol%C3%A1%2C%20quero%20ajuda%20para%20levantar%20a%20documenta%C3%A7%C3%A3o%20necess%C3%A1ria%20para%20o%20meu%20processo"
            target="_blank"
